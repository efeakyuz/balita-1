  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <a style="color:#0a93a6; text-decoration:none;"> Oguzhan Bayraktar ve Efe Akyuz</a> - Tüm hakları saklı olmak üzere. &copy;<script>document.write(new Date().getFullYear());</script>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
      </div>
    </div>
  </div>
